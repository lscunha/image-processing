...
[(clique aqui para ver o meu perfil na plataforma)](https://web.dio.me/users/lucas_lsc)
#### Tecnologia: Python
#### Data: 06/11/2022
-----------------------------------------
### Descrição
O pacote "image_processing-test" é usado para fazer:

- Módulo "Processing":
  - Correspondência do histograma;
...
- Módulo "Utils":
  ...
  - Salvar imagem;
  - Plota imagem;
  - coletando o resultado do gráfico;
  - platando histograma;
---------------------------------------------
